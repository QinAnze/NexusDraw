...
**开箱即用** — 内置完整的 Python 3.13 和 R 4.6.1 便携环境，无需手动安装任何依赖。
...
- 支持任意 OpenAI 兼容 API（OpenAI / DeepSeek / LongCat 等）
...
1. 下载 `NexusDraw-portable-win64.zip`
2. 解压到任意目录
3. 双击 `NexusDraw.exe`
4. 配置 API：`设置 → AI 配置` 填入 Base URL / API Key / Model
5. 上传数据，选择语言和配色，开始绘图
